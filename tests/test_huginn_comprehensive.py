#!/usr/bin/env python3
"""Comprehensive test of Huginn Advanced Security Scanner"""
...
class HuginnTester:
    ...
    async def test_profile(self, profile_name):
        ...
        try:
            scanner = HuginnVulnScanner(self.target, profile=profile_name.lower(), verify_ssl=False)
    ...
    async def run_comprehensive_test(self):
        ...
        print(f"🎯 HUGINN ADVANCED SECURITY SCANNER - COMPREHENSIVE TEST")
        print(f"Target: {self.target}")
