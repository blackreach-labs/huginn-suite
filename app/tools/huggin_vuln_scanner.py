...
from ..core.huggin_config_manager import ConfigManager
...
class HugginVulnScanner:
    ...
    async def scan(self, progress_callback=None):
        ...
        try:
            ...
            if progress_callback:
                progress_callback(len(self.scan_phases), "Starting Huggin vulnerability scan")
    ...
    async def _integrate_with_assets(self):
        ...
        try:
            ...
            print(f"Integrating Huggin scan results with asset inventory for profile: {current_tenant}")
    ...
    def _generate_html_report(self):
        ...
        <body>
        <div class="header">
            <h1>Huggin Security Scan Report</h1>
