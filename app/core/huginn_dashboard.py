...
from .huginn_results_analyzer import huginn_analyzer
...
class HuginnDashboard(QWidget):
    """Comprehensive Huginn scanner results dashboard"""
    ...
    def setup_ui(self):
        ...
        title_label = QLabel("🚀 Huginn Advanced Security Scanner - Results Dashboard")
    ...
    def generate_html_report(self):
        ...
        if self.analysis_results:
            html_report = huginn_analyzer.generate_detailed_report(self.analysis_results)
...
huginn_dashboard = HuginnDashboard()