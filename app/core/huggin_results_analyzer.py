# app/core/huggin_results_analyzer.py
import json
...
class HugginResultsAnalyzer:
    """Advanced analysis and reporting for Huggin scanner results"""
    ...
    def analyze_scan_results(self, scan_results: Dict) -> Dict[str, Any]:
        """Comprehensive analysis of Huggin scan results"""
    ...
    def _store_analysis_results(self, target: str, analysis: Dict):
        ...
        try:
            scan_id = f"huggin_analysis_{datetime.now().strftime('%Y%m%d_%H%M%S')}"
            
            centralized_scan_data.add_scan_result(
                scan_id=scan_id,
                tenant_id=self.tenant_id,
                scan_type="huggin_analysis",
                target=target,
                scanner="huggin_results_analyzer",
    ...
    def generate_detailed_report(self, analysis: Dict) -> str:
        ...
        <html>
        <head>
            <title>Huggin Security Assessment Report</title>
            <style>
        ...
        <body>
            <div class="header">
                <h1>🛡️ Huggin Security Assessment Report</h1>
...
# Global instance
huggin_analyzer = HugginResultsAnalyzer()